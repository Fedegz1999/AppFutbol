...
const logo = (team:string) => {
   ...
   : null}
     ...
     const key = process.env.NEXT_PUBLIC_SERIEA1
     const key2 = process.env.NEXT_PUBLIC_SERIEA2
     const key3 = process.env.NEXT_PUBLIC_SERIEA3
     const key4 = process.env.NEXT_PUBLIC_SERIEA4
