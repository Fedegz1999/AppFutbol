...
export default function bundesliga(data: any) {
   ...
   : null}
     ...
     const key = process.env.NEXT_PUBLIC_BUNDESLIGA1
     const key2 = process.env.NEXT_PUBLIC_BUNDESLIGA2
     const key3 = process.env.NEXT_PUBLIC_BUNDESLIGA3
     const key4 = process.env.NEXT_PUBLIC_BUNDESLIGA4
