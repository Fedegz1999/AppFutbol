...
<td className="md:w-60 sm:w-auto flex items-center text-left  border-solid border-r-2 justify-start"><img className="w-6" src={props.escudo(a.teamName)}></img> {a.knownName} </td>
