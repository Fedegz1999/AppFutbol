...
return (
    ...
    <td className="text-center py-3 md:w-40 w-full  items-center bg-cyan-800 flex justify-start"><img className='md:w-6 w-4 h-4 md:h-6' src={props.escudo(a.home.name)}></img>{a.home.name}</td>
    <td className="text-center items-center justify-center flex py-3">vs</td>
    <td className="text-center py-3 md:w-40 w-full  items-center bg-cyan-800 flex justify-center  md:justify-end">{a.away.name}<img className='md:w-6 w-4 h-4 md:h-6 flex justify-end' src={props.escudo(a.away.name)}></img></td>
