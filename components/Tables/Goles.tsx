...
<td className="md:w-60 sm:w-auto border-solid border-r-2 flex items-center text-left  justify-start"><img className="w-6" src={props.escudo(a.teamName)}></img> {a.knownName} </td>
